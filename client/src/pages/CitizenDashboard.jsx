          ...
          <div className="glass rounded-3xl p-6 shadow-sm border border-gray-150/40 space-y-4">
            ...
            <div className="space-y-2.5">
              ...
              {userLeaderboardInfo && rank > 3 && (
                <div className="flex items-center justify-between p-2.5 rounded-xl border border-emerald-100 bg-emerald-50/40 dark:border-emerald-950 dark:bg-emerald-950/10 text-xs mt-4">
                  <div className="flex items-center gap-2.5 min-w-0">
                    <span className="font-black text-[10px] text-emerald-650 w-4">{rank}</span>
                    ...
                    <span className="font-black text-emerald-850 dark:text-emerald-300 truncate">{userLeaderboardInfo.name} (You)</span>
                  </div>
                  <span className="font-black text-emerald-700 dark:text-emerald-450 text-[10px]">{userLeaderboardInfo.points} pts</span>
                </div>
              )}
            </div>
          </div>
